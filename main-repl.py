...
def end(update, context):
    ...
    txt = 'You can now use /add to add competitions.' if len(
        d[name]['teams']) else 'Your old teams are still saved. You can use /add to add new teams'
...
def main():
    ...
    conv_handler = ConversationHandler(
        entry_points=[CommandHandler(
            'start', start), CommandHandler('restart', restart)],
        states={
            FIRST: [
